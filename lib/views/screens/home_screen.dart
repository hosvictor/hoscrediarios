...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Lista de widgets que representam as telas
  final List<Widget> _screens = [
    const Center(child: Text('Home Screen')), // Substitua com o conteúdo real da tela inicial
    UserDetailsScreen(),
    DebtScreen(),
    const HistoricScreen(),
    Container(), // Placeholder para WhatsApp
  ];
      ...
      body: Stack(
        children: [
          ...
          const Positioned(
            ...
            right: 0,
            child: CustomHeader(
              imageUrl: 'https://mbfarmacias.com.br/wp-content/uploads/2023/04/ABR23-Logo-novo-MBColorido-2.png',
              nome: 'MB Farmácias',
            ),
          ),
        ],
